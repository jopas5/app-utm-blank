...
@Component({
  selector: 'app-estado-beca',
  templateUrl: './estado-beca.component.html',
  styleUrls: ['./estado-beca.component.scss']
})
export class EstadobecaComponent implements OnInit {
  ...
  get_Periodo_ano() {
  this.api.get_periodo_ano().subscribe((data: any) => {
      this.periodos = data;
    }, (error) => {
